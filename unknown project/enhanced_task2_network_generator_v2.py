#!/usr/bin/env python3
"""
Enhanced Task 2 Network Automation Generator v2
Creates complete Cisco Packet Tracer network configurations
Based on the complete Task 2 network topology diagram
Properly handles WAN links (red zigzag) vs LAN links (straight lines)
...
class EnhancedTask2NetworkGeneratorV2:
    def __init__(self):
        ...
        self.network_topology = {
            "routers": {
                ...
                "R1": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.1.12.1", "mask": "255.255.255.252", "connected_to": "R2", "type": "ethernet"},
                        "g0/1": {"ip": "192.168.1.1", "mask": "255.255.255.0", "connected_to": "SW1", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                ...
                "R2": {
                    "model": "4331",
                    "interfaces": {
                        "g0/0/0": {"ip": "10.1.12.2", "mask": "255.255.255.252", "connected_to": "R1", "type": "ethernet"},
                        "g0/0/1": {"ip": "10.2.23.1", "mask": "255.255.255.252", "connected_to": "R3", "type": "ethernet"},
                        "g0/1/0": {"ip": "10.2.24.1", "mask": "255.255.255.252", "connected_to": "R4", "type": "ethernet"},
                        "s0/0/0": {"ip": "10.2.25.1", "mask": "255.255.255.252", "connected_to": "R5", "type": "wan", "dce": True, "clock_rate": "1544000"},
                        "g0/1/1": {"ip": "192.168.2.1", "mask": "255.255.255.0", "connected_to": "SW2", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.1.12.0", "wildcard": "0.0.0.3", "area": "0"},
                ...
                "R3": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.2.23.2", "mask": "255.255.255.252", "connected_to": "R2", "type": "ethernet"},
                        "g0/1": {"ip": "10.3.36.1", "mask": "255.255.255.252", "connected_to": "R6", "type": "ethernet"},
                        "g0/2": {"ip": "192.168.3.1", "mask": "255.255.255.0", "connected_to": "SW3", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.2.23.0", "wildcard": "0.0.0.3", "area": "0"},
                ...
                "R4": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.2.24.2", "mask": "255.255.255.252", "connected_to": "R2", "type": "ethernet"},
                        "g0/1": {"ip": "192.168.4.1", "mask": "255.255.255.0", "connected_to": "SW4", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.2.24.0", "wildcard": "0.0.0.3", "area": "0"},
                ...
                "R5": {
                    "model": "2901",
                    "interfaces": {
                        "s0/0/0": {"ip": "10.2.25.2", "mask": "255.255.255.252", "connected_to": "R2", "type": "wan", "dce": False},
                        "g0/0": {"ip": "192.168.5.1", "mask": "255.255.255.0", "connected_to": "SW5", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.2.25.0", "wildcard": "0.0.0.3", "area": "0"},
                ...
                "R6": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.3.36.2", "mask": "255.255.255.252", "connected_to": "R3", "type": "ethernet"},
                        "g0/1": {"ip": "10.6.67.1", "mask": "255.255.255.252", "connected_to": "R7", "type": "ethernet"},
                        "g0/2": {"ip": "192.168.6.1", "mask": "255.255.255.0", "connected_to": "SW6", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.3.36.0", "wildcard": "0.0.0.3", "area": "0"},
                ...
                "R7": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.6.67.2", "mask": "255.255.255.252", "connected_to": "R6", "type": "ethernet"},
                        "g0/1": {"ip": "10.7.78.1", "mask": "255.255.255.252", "connected_to": "R8", "type": "ethernet"},
                        "g0/2": {"ip": "192.168.7.1", "mask": "255.255.255.0", "connected_to": "SW7", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.6.67.0", "wildcard": "0.0.0.3", "area": "0"},
                ...
                "R8": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.7.78.2", "mask": "255.255.255.252", "connected_to": "R7", "type": "ethernet"},
                        "g0/1": {"ip": "192.168.8.1", "mask": "255.255.255.0", "connected_to": "SW8", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.7.78.0", "wildcard": "0.0.0.3", "area": "0"},
                ...
                "R11": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.11.12.1", "mask": "255.255.255.252", "connected_to": "R12", "type": "ethernet"},
                        "g0/1": {"ip": "192.168.11.1", "mask": "255.255.255.0", "connected_to": "SW11", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                ...
                "R12": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.11.12.2", "mask": "255.255.255.252", "connected_to": "R11", "type": "ethernet"},
                        "g0/1": {"ip": "10.12.13.1", "mask": "255.255.255.252", "connected_to": "R13", "type": "ethernet"},
                        "g0/2": {"ip": "192.168.12.1", "mask": "255.255.255.0", "connected_to": "SW12", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.11.12.0", "wildcard": "0.0.0.3", "area": "1"},
                ...
                "R13": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.12.13.2", "mask": "255.255.255.252", "connected_to": "R12", "type": "ethernet"},
                        "g0/1": {"ip": "10.13.14.1", "mask": "255.255.255.252", "connected_to": "R14", "type": "ethernet"},
                        "g0/2": {"ip": "192.168.13.1", "mask": "255.255.255.0", "connected_to": "SW13", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.12.13.0", "wildcard": "0.0.0.3", "area": "1"},
                ...
                "R14": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.13.14.2", "mask": "255.255.255.252", "connected_to": "R13", "type": "ethernet"},
                        "g0/1": {"ip": "10.14.15.1", "mask": "255.255.255.252", "connected_to": "R15", "type": "ethernet"},
                        "g0/2": {"ip": "192.168.14.1", "mask": "255.255.255.0", "connected_to": "SW14", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.13.14.0", "wildcard": "0.0.0.3", "area": "1"},
                ...
                "R15": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.14.15.2", "mask": "255.255.255.252", "connected_to": "R14", "type": "ethernet"},
                        "g0/1": {"ip": "10.15.16.1", "mask": "255.255.255.252", "connected_to": "R16", "type": "ethernet"},
                        "g0/2": {"ip": "192.168.15.1", "mask": "255.255.255.0", "connected_to": "SW15", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.14.15.0", "wildcard": "0.0.0.3", "area": "1"},
                ...
                "R16": {
                    "model": "2901",
                    "interfaces": {
                        "g0/0": {"ip": "10.15.16.2", "mask": "255.255.255.252", "connected_to": "R15", "type": "ethernet"},
                        "g0/1": {"ip": "192.168.16.1", "mask": "255.255.255.0", "connected_to": "SW16", "vlan_gateway": True, "type": "ethernet"}
                    },
                    "ospf_networks": [
                        {"network": "10.15.16.0", "wildcard": "0.0.0.3", "area": "1"},
    ...
    def generate_router_config(self, router_name):
        """Generate complete router configuration with proper WAN/LAN interface handling"""
        router_data = self.network_topology["routers"][router_name]
        model = router_data.get("model", "2901")
        
        config = f"""!
! {router_name} Configuration - Enhanced Task 2 Network v2 ({model})
! Generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
! Properly handles WAN links (Serial) vs LAN links (Ethernet)
! Excludes ISP devices as specified
!
version 15.1
...
"""
        ...
        for interface, config_data in router_data["interfaces"].items():
            interface_type = config_data.get("type", "ethernet")
            
            if interface_type == "wan":
                # Serial/WAN interface configuration
                config += f"""!
interface Serial{interface}
 description WAN link to {config_data['connected_to']}
 ip address {config_data['ip']} {config_data['mask']}
 encapsulation ppp
"""
                # Add clock rate if this is DCE side
                if config_data.get("dce", False):
                    clock_rate = config_data.get("clock_rate", "1544000")
                    config += f" clock rate {clock_rate}\n"
...
*   Enhanced Task 2 Network v2 - """ + router_name + f""" ({model})   *
*     WAN/LAN links properly configured *
...
"""
    ...
    def generate_switch_config(self, switch_name):
        ...
        config = f"""!
! {switch_name} Configuration - Enhanced Task 2 Network v2
! Generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
!
version 15.0
no service timestamps log datetime msec
...
******************************************
*        AUTHORIZED ACCESS ONLY         *
*   Enhanced Task 2 Network v2 - {switch_name}     *
******************************************
^C
!
line con 0
...
"""
    ...
    def generate_server_config(self, server_name):
        ...
        config = f"""# {server_name} Configuration - Enhanced Task 2 Network v2
# Generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
...
"""
    ...
    def create_packet_tracer_instructions(self):
        """Create comprehensive Packet Tracer setup instructions with WAN/LAN distinctions"""
        instructions = f"""
...
"""
    ...
    def generate_all_configs(self):
        """Generate all configuration files for the enhanced network with WAN/LAN distinctions"""
        # Create output directory
        output_dir = "Enhanced_Task2_Network_Configs_v2"
        if not os.path.exists(output_dir):
            os.makedirs(output_dir)
        
        print(f"Generating Enhanced Task 2 Network Configurations v2...")
        print(f"Output directory: {output_dir}")
        print(f"Properly handling WAN links (Serial) vs LAN links (Ethernet)")
        ...
        for router_name in self.network_topology["routers"]:
            ...
            # Check if router has WAN interfaces
            has_wan = any(iface_data.get("type") == "wan" 
                         for iface_data in self.network_topology["routers"][router_name]["interfaces"].values())
            wan_indicator = " (includes WAN)" if has_wan else ""
            
            print(f"   [OK] {router_name}_config.txt ({model}){wan_indicator}")
        ...
        with open(f"{output_dir}/Enhanced_Packet_Tracer_Instructions_v2.md", 'w') as f:
            f.write(instructions)
        print(f"   [OK] Enhanced_Packet_Tracer_Instructions_v2.md")
        
        # Generate topology JSON for reference
        with open(f"{output_dir}/enhanced_network_topology_v2.json", 'w') as f:
            json.dump(self.network_topology, f, indent=2)
        print(f"   [OK] enhanced_network_topology_v2.json")
...
## Devices Included:
- **Routers**: {len(self.network_topology['routers'])} (1x 4331, 13x 2901)
...
"""
        ...
        with open(f"{output_dir}/Device_Summary_v2.md", 'w') as f:
            f.write(summary)
        print(f"   [OK] Device_Summary_v2.md")
        
        print(f"\nEnhanced Task 2 Network Generation v2 Complete!")
        ...
        print(f"   - Enhanced setup instructions v2")
        print(f"   - Device summary and topology reference")
        print(f"\nCRITICAL UPDATES:")
        print(f"   - R2-R5 connection now configured as WAN link (Serial)")
        print(f"   - R2 requires EHWIC-4ESG module + Serial interface")
        print(f"   - Use Serial DCE cable for R2-R5 connection")
        
        return output_dir

def main():
    """Main function to generate the enhanced network with WAN/LAN distinctions"""
    print("=" * 70)
    print("ENHANCED TASK 2 NETWORK AUTOMATION GENERATOR v2")
    print("WAN LINKS (RED ZIGZAG) vs LAN LINKS PROPERLY CONFIGURED")
    print("ISP DEVICES EXCLUDED AS REQUESTED")
    print("=" * 70)
    
    generator = EnhancedTask2NetworkGeneratorV2()
    output_dir = generator.generate_all_configs()
    
    print(f"\nNext Steps:")
    print(f"1. Open Packet Tracer")
    print(f"2. Add EHWIC-4ESG module to R2 (4331 router)")
    print(f"3. Use Serial DCE cable for R2-R5 WAN connection")
    print(f"4. Follow instructions in '{output_dir}/Enhanced_Packet_Tracer_Instructions_v2.md'")
    print(f"5. Copy configurations from the generated .txt files")
    print(f"6. Test WAN link connectivity specifically")
    
    print(f"\nYour enhanced Task 2 network v2 is ready to deploy!")
    print(f"Key improvement: R2-R5 WAN link properly configured as Serial connection!")
