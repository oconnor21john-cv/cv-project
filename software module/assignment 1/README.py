...
- Running score tracked during the quiz
- Final score display
...
Step 1: Starting the Program
   - Open quiz_application.py in IDLE and run
...
Step 4: Answering Questions
   ...
   - For multiple choice: Type a, b, c, or d and press Enter
   - For text questions: Type your answer (e.g., "red" or "three")
...
ANSWER INPUT:
X Empty answer → Error: "Answer cannot be empty. Please enter a, b, c, or d."
X Invalid option → Error: "Please enter a valid option: a, b, c, or d."
- Valid: a, b, c, or d (case-insensitive)
...
README.py (this file - open in IDLE to read)
...
Questions: List of dictionaries
  [{
    "question": str,
    "options": dict (for multiple choice) or None (for text),
    "answer": str,
    "type": str (optional, "text" for text questions),
    "explanation": str
  }]
